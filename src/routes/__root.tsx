  ...
  return (
    <div className="flex min-h-screen items-center justify-center bg-background px-4">
      <div className="max-w-md text-center">
        ...
        <p className="mt-2 text-sm text-muted-foreground">
          Si è verificato un problema. Prova ad aggiornare la pagina o torna alla home.
        </p>
...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  ...
  head: ({ loaderData }) => ({
    meta: [
      ...
      { title: "Auto Prime — Auto usate di qualità a Pompei" },
      {
        name: "description",
        content:
          "Auto Prime, concessionaria di auto usate a Pompei (NA). Auto controllate, prezzi onesti, garanzia e permuta.",
      },
      { name: "author", content: "Auto Prime" },
    ...
    links: [
      ...
      {
        rel: "stylesheet",
        href: "https://fonts.googleapis.com/css2?family=Oswald:wght@500;700&family=Inter:wght@400;500;600&family=Space+Mono:wght@400;700&display=swap",
      },
    ...
    scripts: [
      {
        ...
        children: JSON.stringify(dealerJsonLd(loaderData ?? null)),
      },
    ],
  }),
